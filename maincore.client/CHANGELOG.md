...
- Cree un proyecto de Angular con ng: `ng new maincore.client --defaults --skip-install --skip-git --no-standalone `.
...
- Crear archivo de proyecto (`maincore.client.esproj`).
